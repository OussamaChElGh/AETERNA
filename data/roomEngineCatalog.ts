...
export const ROOM_ENGINE_CATALOG: RoomCatalogItem[] = [
  ...
  {
    id: 'book_tower',
    name: 'Torre de Tomos Académicos',
    description: 'Pila de tomos encuadernados en cuero formando una torre de sabiduría.',
    discipline: 'general',
    category: 'books',
    rarity: 'common',
    assetId: 'asset_book_tower',
    placementSurface: 'desk',
    canRotate: true
  },
  {
    id: 'scroll_wall',
    name: 'Pergamino Enmarcado',
    description: 'Pergamino antiguo enmarcado en caoba con sellos de lacre y caligrafía iluminada.',
    discipline: 'philosophy',
    category: 'decoration',
    rarity: 'uncommon',
    assetId: 'asset_scroll_wall',
    placementSurface: 'wall',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'metodo-cientifico' }
  },
  {
    id: 'codex_stand',
    name: 'Códice Iluminado en Atril',
    description: 'Códice medieval abierto sobre atril de madera tallada mostrando miniaturas doradas.',
    discipline: 'philosophy',
    category: 'books',
    rarity: 'epic',
    assetId: 'asset_codex_stand',
    placementSurface: 'floor',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'metodo-cientifico' }
  },
  {
    id: 'fern_ceramic',
    name: 'Helecho en Maceta Esmaltada',
    description: 'Helecho frondoso en maceta de cerámica verde esmaltada con motivos botánicos.',
    discipline: 'biology',
    category: 'plants',
    rarity: 'common',
    assetId: 'asset_fern_ceramic',
    placementSurface: 'floor',
    canRotate: true
  },
  {
    id: 'hanging_ivy_long',
    name: 'Hiedra Colgante Larga',
    description: 'Enredadera de hiedra colgante en cascada sobre soporte decorativo de latón.',
    discipline: 'biology',
    category: 'plants',
    rarity: 'common',
    assetId: 'asset_hanging_ivy_long',
    placementSurface: 'wall',
    canRotate: true
  },
  {
    id: 'cactus_desk',
    name: 'Cactus de Escritorio',
    description: 'Pequeño cactus en maceta de cerámica, compañero estoico de largas jornadas de estudio.',
    discipline: 'biology',
    category: 'plants',
    rarity: 'common',
    assetId: 'asset_cactus_desk',
    placementSurface: 'desk',
    canRotate: true
  },
  {
    id: 'alembic_copper',
    name: 'Alambique de Cobre Antiguo',
    description: 'Alambique de cobre martillado sobre trípode de hierro forjado para destilaciones alquímicas.',
    discipline: 'physics',
    category: 'scientific',
    rarity: 'rare',
    assetId: 'asset_alembic_copper',
    placementSurface: 'desk',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'termodinamica' }
  },
  {
    id: 'flasks_trio',
    name: 'Trío de Matraces de Vidrio',
    description: 'Juego de tres matraces de vidrio soplado con líquidos de colores sobre bandeja de latón.',
    discipline: 'physics',
    category: 'scientific',
    rarity: 'uncommon',
    assetId: 'asset_flasks_trio',
    placementSurface: 'desk',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'materia-y-energia' }
  },
  {
    id: 'side_table_marble',
    name: 'Mesa Auxiliar de Mármol',
    description: 'Pequeña mesa auxiliar redonda con tapa de mármol veteado y patas de caoba torneadas.',
    discipline: 'general',
    category: 'furniture',
    rarity: 'common',
    assetId: 'asset_side_table_marble',
    placementSurface: 'floor',
    canRotate: true
  },
  {
    id: 'coat_rack_brass',
    name: 'Perchero de Latón',
    description: 'Perchero de pie con ganchos de latón pulido y base de caoba para togas y capas académicas.',
    discipline: 'general',
    category: 'furniture',
    rarity: 'common',
    assetId: 'asset_coat_rack_brass',
    placementSurface: 'floor',
    canRotate: true
  },
  {
    id: 'trunk_leather',
    name: 'Baúl de Cuero Antiguo',
    description: 'Baúl de viaje forrado en cuero marrón con refuerzos de latón, ideal para guardar manuscritos.',
    discipline: 'general',
    category: 'furniture',
    rarity: 'uncommon',
    assetId: 'asset_trunk_leather',
    placementSurface: 'floor',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'como-piensa-un-fisico' }
  },
  {
    id: 'hourglass_brass',
    name: 'Reloj de Arena de Latón',
    description: 'Reloj de arena de latón y vidrio soplado con arenas doradas sobre base de caoba.',
    discipline: 'physics',
    category: 'decoration',
    rarity: 'uncommon',
    assetId: 'asset_hourglass_brass',
    placementSurface: 'desk',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'cinematica' }
  },
  {
    id: 'portrait_aristotle',
    name: 'Retrato de Aristóteles',
    description: 'Retrato al óleo de Aristóteles con marco dorado tallado, guardián del pensamiento clásico.',
    discipline: 'philosophy',
    category: 'decoration',
    rarity: 'epic',
    assetId: 'asset_portrait_aristotle',
    placementSurface: 'wall',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'metodo-cientifico' }
  },
  {
    id: 'candlestick_trio',
    name: 'Candelabro de Mesa',
    description: 'Candelabro de latón con tres velas de cera sobre bandeja reflectante.',
    discipline: 'general',
    category: 'decoration',
    rarity: 'common',
    assetId: 'asset_candlestick_trio',
    placementSurface: 'desk',
    canRotate: true
  },
  {
    id: 'rug_oval_burgundy',
    name: 'Alfombra Ovalada Burdeos',
    description: 'Alfombra ovalada en tonos burdeos y crema con motivo de hojas de acanto.',
    discipline: 'general',
    category: 'decoration',
    rarity: 'uncommon',
    assetId: 'asset_rug_oval_burgundy',
    placementSurface: 'floor',
    canRotate: true,
    unlockCondition: { type: 'article_completed', targetId: 'relatividad-general' }
  },
