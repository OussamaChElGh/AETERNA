...
export const ACTIVITY_CAPABILITY_REGISTRY: Record<string, ActivityCapabilityMapping> = {
  ...
  AeternaExercise: {
    componentType: 'AeternaExercise',
    name: 'Ejercicio Tradicional Aeterna',
  ...
  AeternaDecisionBox: {
    componentType: 'AeternaDecisionBox',
    name: 'Caja de Decisión Aeterna',
  ...
  AeternaFlowchart: {
    componentType: 'AeternaFlowchart',
    name: 'Diagrama de Flujo Interactivo Aeterna',
