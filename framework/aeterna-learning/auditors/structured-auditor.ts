...
/**
 * Builds a ParsedArticleStructure directly from a structured AeternaArticle JSON
...
export function buildParsedFromJson(slug: string): ParsedArticleStructure {
  ...
  const article = JSON.parse(fs.readFileSync(file, 'utf8')) as AeternaArticleJSON;
  ...
  return {
    ...
    slug,
    author: metadata.author || 'Aeterna',
