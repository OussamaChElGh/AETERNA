...
function runCalibrationTests() {
  console.log('====================================================');
  console.log('    RUNNING AETERNA FINAL CALIBRATION TESTS        ');
  console.log('====================================================\n');
  ...
  // Test 1: Explicar razonamiento ≠ practicar razonamiento
  {
    const mock = createMockParsedArticle({
      ...
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: '¿Qué es una magnitud física?', detectedCognitiveLevels: ['conceptual_explain'] }
      ]
    });
  ...
  // Test 2: Un artículo con buen contenido conceptual pero poca práctica de reasoning no obtiene máxima puntuación
  {
    const mock = createMockParsedArticle({
      ...
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Defina unidad base', detectedCognitiveLevels: ['conceptual_explain'] }
      ]
    });
    const report = evaluateScoring(mock, profile);
  ...
  // Test 4: Cuatro ejercicios con el mismo formato UI pueden tener alta variedad cognitiva
  {
    const mock = createMockParsedArticle({
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: '¿Qué es el metro?', detectedCognitiveLevels: ['conceptual_explain'] },
        { id: '2', type: 'AeternaExercise', layerId: 'intermedio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Calcule la velocidad', detectedCognitiveLevels: ['procedural_apply'] },
        { id: '3', type: 'AeternaExercise', layerId: 'avanzado', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Estime la cantidad de afinadores de Fermi', detectedCognitiveLevels: ['reasoning_estimate'] },
        { id: '4', type: 'AeternaExercise', layerId: 'avanzado', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Justifique en un contexto cotidiano', detectedCognitiveLevels: ['transfer_new_context'] }
      ]
    });
    const report = evaluateScoring(mock, profile);
  ...
  // Test 5: Cuatro componentes UI distintos pueden tener baja variedad cognitiva
  {
    const mock = createMockParsedArticle({
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: '¿Qué es la longitud?', detectedCognitiveLevels: ['conceptual_explain'] },
        { id: '2', type: 'AeternaDecisionBox', layerId: 'intermedio', hasHint: true, hasXP: true, hasSolution: true, questionText: '¿Qué es la masa?', detectedCognitiveLevels: ['conceptual_explain'] },
  ...
  // Test 6: NOT_EVALUATED reduce confidence pero no equivale automáticamente a FAIL
  {
    const mock = createMockParsedArticle({
      ...
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Estime Fermi', detectedCognitiveLevels: ['reasoning_estimate'] },
        { id: '2', type: 'AeternaExercise', layerId: 'intermedio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Calcule la conversión', detectedCognitiveLevels: ['procedural_apply'] },
        { id: '3', type: 'AeternaExercise', layerId: 'avanzado', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Justifique la respuesta', detectedCognitiveLevels: ['reasoning_justify'] }
      ]
    });
    const report = evaluateScoring(mock, profile);
    assert(
