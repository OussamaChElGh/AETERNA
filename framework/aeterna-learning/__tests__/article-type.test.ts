...
function runTests() {
  console.log('====================================================');
  console.log('        RUNNING AETERNA ARTICLE TYPE TESTS          ');
  console.log('====================================================\n');
  ...
  // Test 1: methodological + 3 ejercicios → PASS (no volume warning)
  {
    const mock = createMockParsedArticle({
      ...
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q1' },
        { id: '2', type: 'AeternaExercise', layerId: 'intermedio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q2' },
        { id: '3', type: 'AeternaExercise', layerId: 'avanzado', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q3' }
      ]
    });
  ...
  // Test 4: conceptual + 5 ejercicios → PASS
  {
    const mock = createMockParsedArticle({
      ...
      exercises: [
        { id: '1', type: 'AeternaExercise', layerId: 'inicio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q1' },
        { id: '2', type: 'AeternaExercise', layerId: 'intermedio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q2' },
        { id: '3', type: 'AeternaExercise', layerId: 'intermedio', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q3' },
        { id: '4', type: 'AeternaExercise', layerId: 'avanzado', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q4' },
        { id: '5', type: 'AeternaExercise', layerId: 'avanzado', hasHint: true, hasXP: true, hasSolution: true, questionText: 'Q5' }
      ]
    });
    const report = evaluateScoring(mock, profile);
    const volumeWarn = report.warnings.some(w => w.includes('Volumen total de ejercicios'));
