...
export interface AeternaExperienceResult {
...
export type InterventionCategory = 'PEDAGOGY' | 'VISUAL' | 'CONTENT' | 'DISCOVERABILITY' | 'AETERNA' | 'KNOWLEDGE_BENCHMARK';
