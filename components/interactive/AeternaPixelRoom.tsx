...
export function AeternaPixelRoom({ 
  ...
  const PHYSICS_CATALOG: FurnitureCatalogItem[] = [
    {
      ...
      category: 'Física',
      icon: '/images/aeterna_pixel_telescope.png',
      defaultX: 22,
      defaultY: 35,
    ...
    },
    {
      ...
      category: 'Física',
      icon: '/images/aeterna_pixel_prism.png',
      defaultX: 48,
      defaultY: 55,
    ...
    },
    {
      ...
      category: 'Física',
      icon: '/images/aeterna_pixel_bookshelf.png',
      defaultX: 72,
      defaultY: 30,
    ...
    },
    {
      ...
      category: 'Física',
      icon: '/images/aeterna_pixel_trophy.png',
      defaultX: 75,
      defaultY: 65,
