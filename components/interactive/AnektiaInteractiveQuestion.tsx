...
interface AnektiaProps {
  content: string;
  onResult?: (correct: boolean) => void;
}

export function AnektiaInteractiveQuestion({ content, onResult }: AnektiaProps) {
  ...
  const handleSelect = (index: number) => {
    ...
    if (isCorrect) {
      ...
      markQuestionAnswered(questionId, xp, `Anektia Quiz: ${tipoText}`);
