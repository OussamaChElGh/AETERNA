const COMPONENT_NAMES = [
  ...
  'ArgumentEvaluation', 'SequenceBuilder', 'AeternaDecisionBox', 'AeternaExercise',
  'PedagogicalContentBlock', 'Connect', 'HiddenAssumption', 'Transfer', 'AeternaEngagement',
  'AeternaFlowchart', 'Flowchart', 'AeternaFormula', 'FormulaBlock', 'Formula',
  'ComparativeTable', 'ProcessVisual', 'VisualData'
];

export function preprocessAeternaContent(rawContent: string): string {
