...
import { Eye, Edit3, Grid, RotateCcw, ArrowLeft, Sparkle, Wrench } from 'lucide-react';
...
export function RoomEngineHUD({
  ...
  return (
    <div className="bg-[#FAF8F5]/90 dark:bg-[#16161F]/90 backdrop-blur-md border border-brand-gold/30 rounded-2xl p-3.5 mb-4 shadow-xl flex flex-wrap items-center justify-between gap-4 font-sans transition-all duration-300">
      {/* Title & Back Button */}
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <h1 className="font-serif text-lg sm:text-xl font-bold text-brand-ink dark:text-white leading-tight">
        ...
        <button
          ...
          className={cn(
            ...
            editMode
              ...
              : "bg-white dark:bg-white/5 text-brand-ink dark:text-brand-offwhite border-brand-gold/30 hover:border-brand-gold hover:bg-brand-gold/10"
          )}
        >
            ...
            <button
              ...
              className={cn(
                ...
                showGrid
                  ...
                  : "bg-white/5 border-black/10 dark:border-white/10 text-brand-muted hover:text-brand-gold"
              )}
            ...
            <button
              ...
              className={cn(
                ...
                showDebugMode
                  ...
                  : "bg-white/5 border-black/10 dark:border-white/10 text-brand-muted hover:text-emerald-500"
              )}
